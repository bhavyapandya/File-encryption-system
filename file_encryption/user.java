...
Connection con=DriverManager.getConnection("jdbc:derby://localhost:1527/file_encryption","file_encrypt","123");
...
if(rs1.next())
	...
	String file=path+"/"+x+"."+rs1.getString(4);
...
is.close();
fos.close();
ps=con.prepareStatement("delete from userrole where fname=?");
ps.setString(1,x);
