...
con=DriverManager.getConnection("jdbc:derby://localhost:1527/file_encryption","file_encrypt","123");
...
FileInputStream fis=new FileInputStream(file1);
   ps.setString(1,x);
ps.setString(2,y);
ps.setString(4,tf3.getText().substring(tf3.getText().lastIndexOf('.')+1));
